//
// Created by Mark Plagge on 8/9/18.
//
...
#ifndef SUPERNEMO_JSON_DTO_HH
#define SUPERNEMO_JSON_DTO_HH
/*
	json_dto
*/
...
public:
  json_output_t(
      ...
      : m_object{object}, m_allocator{allocator} {
    m_object.SetObject();
  }
...
public:
  binder_t(
      ...
      Validator &&validator)
      : m_field_name{field_name}, m_field{field}, m_manopt_policy{std::move(manopt_policy)},
